...
<input id="product" type="hidden" value = "${DiscussDetail.productid }"/>
<input id="classes" type="hidden" value = "${DiscussDetail.classesid }"/>
<input id="reward" type="hidden" value = "${DiscussDetail.reward }"/>
            ...
            <form action="" method="post">
              <div class="layui-row layui-col-space15 layui-form-item">
                <div class="layui-col-md3">
                  ...
                  <div class="layui-input-block">
                    <select id="classesSelect" lay-verify="required" name="classesid" > <!--lay-filter="classesselect"  -->
                       <option value=""></option> 
                ...
                <div class="layui-col-md9">
                  ...
                  <div class="layui-input-block">
                    <input type="text" id="L_title" value="${DiscussDetail.title }" name="title" required lay-verify="required" autocomplete="off" class="layui-input">
              ...
              <div class="layui-row layui-col-space15 layui-form-item" id="LAY_quiz">
                <div class="layui-col-md3">
                  ...
                  <div class="layui-input-block">
                    <select id="productSelect" required lay-verify="required" name="productid">
                      <option value=""></option>
                ...
                <div class="layui-col-md3">
                  ...
                  <div class="layui-input-block">
                    <input type="text" id="L_version" value="${DiscussDetail.version }" name="version" autocomplete="off" class="layui-input">
                  </div>
                </div>
                <div class="layui-col-md6">
                  <label class="layui-form-label" for="L_browser">浏览器</label>
                  <div class="layui-input-block">
                    <input type="text" id="L_browser"  value="${ DiscussDetail.browser}" name="browser" placeholder="浏览器名称及版本，如：IE 11" autocomplete="off" class="layui-input">
                  </div>
                </div>
              </div>
              <div class="layui-form-item layui-form-text">
                <div class="layui-input-block">
                  <textarea id="L_content" name="content"  required lay-verify="required" placeholder="详细描述" class="layui-textarea fly-editor" style="height: 260px;">${ DiscussDetail.content}</textarea>
                </div>
              </div>
              <div class="layui-form-item">
                <div class="layui-inline">
                  ...
                  <div class="layui-input-inline" style="width: 190px;">
                    <select id="rewardSelect" disabled="true" name="reward">
                      <option value="${DiscussDetail.reward }">${DiscussDetail.reward }</option>
                    </select>
                  </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  ...
                  <input type="hidden" id ="hiddenDiscussid" name="discussid" value="${DiscussDetail.discussid }"/>
                </div>
              ...
              <div class="layui-form-item">
                <button class="layui-btn" type="button" lay-filter="eidtDiscussid" lay-submit>立即更改</button>
              </div>
            </form>
          </div>
        </div>
...
<script>
	...
	layui.config({
		...
		var $ = layui.$, fly = layui.fly,form = layui.form;
		$(function(){
			...
			for(var i = 0 ; i<productselect.options.length;i++){
				if(productid === productselect.options[i].value){
					productselect.options[i].setAttribute('selected','true');
					form.render();
	            }
		    };
			for(var i = 0 ; i<classesselect.options.length;i++){
				if(classesid === classesselect.options[i].value){
					classesselect.options[i].setAttribute('selected','true');
					form.render();
	            }
		    };
		});
